...
| API Key           | Your personal API key from Eden AI                 |
...
Go to the [Eden AI platform](https://app.edenai.run/user/login) and sign in or sign up. New accounts receive free credits to get started.
...
Here is a list of the available actions for Eden AI:

### Actions

- **Chat Completions** — Send a prompt to an AI language model and receive a generated text response. Useful for building conversational agents, answering questions, or generating content through any of Eden AI's supported LLM providers.

- **Analyze Sentiment** — Analyze the sentiment of a given text and determine whether it is positive, negative, or neutral. Ideal for monitoring feedback, reviews, or social media content.

- **Named Entity Recognition** — Identify and extract named entities from text such as people, organizations, locations, dates, and more. Useful for structuring unstructured text data.

- **Text Moderation** — Automatically detect and flag harmful, offensive, or inappropriate content within a given text. Useful for content filtering in user-generated platforms.

- **Topic Extraction** — Extract the key topics and themes from a body of text. Helps categorize and understand large volumes of content at a glance.

- **Translate Text** — Translate text from one language to another using Eden AI's supported translation providers. Supports a wide range of languages for global workflows.
