...
- Displayed on a management dashboard
...
[
  {
    ...
    "json": {
      ...
      "message": "<b>Daily Report:</b><br><br>We processed 3 orders today for a total of $11843.<br>International orders: 0.<br>Top Product: Biker Jacket (100 units)."
    }
  }
]
```
...
```Text
Daily Report:
We processed 3 orders today for a total of $11843.
